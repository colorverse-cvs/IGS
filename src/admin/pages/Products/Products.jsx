        ...
        <>
           <div className="product-label-top-wrapper flex items-center justify-between mb-4 p-4">
                ...
                <button className="bg-brand-700 px-5 py-2 cursor-pointer text-white rounded-lg"
                        onClick={handleOpenAddProductModal}>+ Add Product</button>
           </div>
            ...
            <div className="product-detail-wrapper space-y-6 bg-white p-4 rounded-md">
                ...
                <div className="space-y-4">
                    ...
                    >
                        ...
                        <div className="flex items-center gap-3">
                        <button className="flex items-center gap-2 border px-3 py-1.5 cursor-pointer rounded-md hover:bg-gray-50"
                                onClick={handleOpenEditProductModal}>
                            ✏️ Edit
                        </button>
                        <button className="text-red-600 hover:bg-red-50 p-2 rounded-md cursor-pointer"
            ...
            {openEditProductModal && (
                <EditProductModal onClose={handleCloseEditProductModal} />
            )}

            {openDeleteProductModal && (
                <DeleteProductConfirmationModal onClose={handleCloseDeleteProductModal} />
            )}
