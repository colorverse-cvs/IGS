  ...
  return (
    <div className="bg-white rounded-xl shadow p-6 md:p-4 lg:p-6 md:max-h-[230px] lg:max-h-[230px] overflow-auto">
      <div className="flex justify-between items-center mb-4">
        <p className="text-sm !font-medium">Top 3 Selling Items</p>
      </div>
        ...
        {lowStockDetails.map((item) => (
          <div key={item.id} className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              <div className="w-9 h-9 flex items-center justify-center rounded-full bg-brand-500 text-white !font-medium text-sm">
                {item.id}
              </div>
