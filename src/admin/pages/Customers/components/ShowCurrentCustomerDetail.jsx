export default function ShowCurrentCustomerDetail({ currentCustomerDetail, onClose }) {
                ...
                <div className="mb-6 cursor-default">
                    ...
                    <div className="bg-gray-50 rounded-lg p-4 space-y-2 text-sm">
                        ...
                        <div className="flex justify-between">
                            <span>Name:</span>
                            <span className="font-medium">{currentCustomerDetail.customerName}</span>
                        </div>

                        <div className="flex justify-between">
                            <span>Email:</span>
                            <span className="font-medium">{currentCustomerDetail.emailId}</span>
                        </div>

                        <div className="flex justify-between">
                            <span>Phone:</span>
                            <span className="font-medium">{currentCustomerDetail.mobile}</span>
                        </div>

                        <div className="flex justify-between">
                            <span>Customer Since:</span>
                            <span className="font-medium">{currentCustomerDetail.joinDate}</span>
                        </div>
                    </div>
                </div>
                ...
                <div className="mb-8 cursor-default">
                    ...
                    <div className="bg-gray-50 rounded-lg p-4 text-sm space-y-2">
                        ...
                        <div className="flex justify-between">
                            ...
                            <span className="font-medium">{currentCustomerDetail.totalOrders}</span>
                        </div>
