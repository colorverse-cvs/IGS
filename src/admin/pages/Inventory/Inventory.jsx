      ...
      <div className="search-bar-wrapper bg-white p-4 rounded-lg">
        <div className="relative mb-4">
          <input
            ...
            className="w-full border border-gray-100 rounded-lg pl-10 pr-4 py-2 focus:outline-none focus:ring-2 focus:ring-purple-500 transition focus:border-transparent"
          />
