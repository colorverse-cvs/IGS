    ...
    for (let day = 1; day <= daysInMonth; day++) {
      ...
      days.push(
        <button
          ...
          className={`p-2 text-sm rounded hover:bg-brand-50 transition cursor-pointer ${
            isSelected ? "bg-brand-700 text-white hover:bg-brand-800" : ""
          } ${
            isToday && !isSelected
              ? "border border-brand-700 text-brand-700"
              : ""
          }`}
        >
          {day}
    ...
    return monthNames.map((month, index) => {
      ...
      return (
        <button
          ...
          className={`p-3 text-sm rounded hover:bg-brand-50 transition cursor-pointer ${
            isSelected ? "bg-brand-700 text-white hover:bg-brand-800" : ""
          }`}
        >
          {month.substring(0, 3)}
    ...
    <div className="relative" ref={calendarRef}>
      ...
      <div className="relative">
        <input
          ...
          className={`w-full border rounded px-3 py-2 pr-10 cursor-pointer focus:outline-none focus:ring-1 focus:ring-brand-500 transition ${
