...
export default function CollectionPage() {
  ...
  useEffect(() => {
    ...
    const sectionsArray = Object.keys(productsByCategory).map(
      (categoryName) => {
  ...
  const getCategoryMetadata = (categoryName, categories) => {
    ...
    const categoryMetadata = {
      ...
      "Mavale Statues": {
        ...
        subtitle:
          "Brave companions of Shivaji Maharaj, finely sculpted collectibles.",
      },
      "God Statues": {
        id: "god-statues",
        title: "God Statues",
      ...
      "Home Decor": {
        ...
        title: "Home Decor",
        subtitle:
          "Art pieces designed to elevate and transform any interior space.",
      },
      "Motivational Statues": {
        id: "motivational",
        title: "Motivational Statues",
        subtitle:
          "Inspiring figures symbolizing courage, leadership, and strength.",
      },
    };
