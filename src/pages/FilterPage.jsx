...
import { Search, ArrowLeft, ArrowRight, Filter, X } from "lucide-react";
    ...
    if (filters.category) {
      ...
      filtered = filtered.filter((product) =>
        selected.some((cat) => {
          ...
          const categorySlug =
            product.categoryId || getCategorySlug(product.category || "");
          return (
            categorySlug === cat ||
            (product.category || "")
              .toLowerCase()
    ...
    if (filters.material) {
      ...
      filtered = filtered.filter((product) => {
        ...
        return selected.some((mat) =>
          productMaterial.startsWith(mat.toLowerCase())
        );
      });
    }
          ...
          <div className="px-0 py-3 w-[90%] md:w-[95%]">
            <div className="relative flex items-center">
              <input
                ...
                className="w-full px-2 py-2 border border-gray-300 rounded-lg text-sm focus:ring-1 focus:ring-brand-500 focus:outline-none"
              />
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            ...
            <div className="relative flex justify-between items-center">
              <input
                ...
                className=" w-20% border bg-white border-gray-300 rounded-lg text-sm focus:ring-1 focus:ring-brand-500 focus:border-transparent px-2 py-1.5 focus-visible:outline-0 focus:outline-none"
              />
              <Search
                size={16}
          ...
          {status !== "loading" && paginatedProducts.length === 0 && (
            <div className="text-center py-12">
              ...
              <button
                ...
                className="mt-4 text-brand-600 hover:text-brand-700 font-medium cursor-pointer"
              >
                Clear all filters
              </button>
            </div>
